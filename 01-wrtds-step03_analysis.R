...
for (river in rivers_to_do) { # test of several rivers
  ...
  write.csv(x = egret_error_kalman, file = file.path(path, "WRTDS Outputs", paste0(out_prefix, "ErrorStats_kalman_WRTDS.csv")), row.names = F, na = "")
  ...
  HERON::egret_report(eList_estim = egret_estimation, eList_series = egret_list_out,
    out_path = file.path(path, "WRTDS Outputs", paste0(out_prefix, "WRTDS_output.pdf")))


  # plot kalman
  pdf(file.path(path, "WRTDS Outputs", paste0(out_prefix, "WRTDS_kalman_output.pdf")))

  # flow history
  # plot15(eList1,minYP,maxYP)

  # compare wrtds original and wrtds kalman
  plotWRTDSKalman(egret_kalman)

  # examine model fit
  plotConcTimeDaily(egret_kalman, plotGenConc = TRUE)

  # examine model fit - flux
  plotFluxTimeDaily(egret_kalman, plotGenFlux = TRUE)

  # plot concentration
  plotConcHist(egret_kalman, plotAnnual = FALSE, plotGenConc = TRUE)

  # plot flux
  plotFluxHist(egret_kalman, plotAnnual = FALSE, plotGenFlux = TRUE)
...
# ---- stream_id; element; river_chem; river_disc; out_prefix; start; river_info ----
# ---- egret_disc; egret_chem; egret_info -- `egret::readuser___` ----
# ---- egret_list; egret_list_out -- `egret::mergereport` & `egret::runseries` ----
# ---- egret_estimation -- `egret::modelestimation` ----
# ---- egret_kalman -- `egret::wrtdskalman` ----
# ---- egret_error -- `egret::errorstats` ----
# ---- flux_bias -- `egret::fluxbiasstat` ----
# ---- egret_annual -- `egret::tableresults` ----
# ---- egret_annual_kalman -- `egret::tableresults` ----
# ---- egret_monthly; egret_monthly_kalman -- `egret::calculatemonthlyresults` ----
# ---- egret_concentration; egret_conc_kalman ----
# ---- egret_flownorm -- `heron::egret_trends` ----
# ---- end; loop_diagnostic ----
